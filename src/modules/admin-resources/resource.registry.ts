...
const productsResource = defineResource({
  ...
  fields: [
    ...
    { key: 'careNote', label: 'Packaging / care note', kind: 'long', required: false, max: 1000, help: 'Shown under the description on the product page. Leave empty to use the site default ("Every gift leaves the studio checked twice…").' },
    { key: 'deliveryNote', label: 'Delivery note', kind: 'long', required: false, max: 2000, help: 'Delivery tab text on the product page. Leave empty to use the site default.' },
